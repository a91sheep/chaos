package com.yunyin.print.main.api.common.http;
...
//                    .addPart("in_url", stringBody1).setCharset(CharsetUtils.get("UTF-8")).build();
            ...
            params.add(new BasicNameValuePair("in_url", filePath));

            httpPost.setEntity(new UrlEncodedFormEntity(params, CharsetUtils.get("UTF-8")));
