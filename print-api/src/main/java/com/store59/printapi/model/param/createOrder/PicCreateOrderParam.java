 ...
 * @version 创建时间：2016年5月12日 上午10:27:49 图片打印param类
 */
public class PicCreateOrderParam extends AppBaseParam {
	private String token;
	private String uid;// h5必填
	...
	private Byte open_ad = 0; // 是否免费打印 0不开启 1开启免费打印
	...
	private Byte docType = 0;// 订单类型：0:图片，1:文档；默认为0
	// 使用优惠券后返回结果需要增加的
	...
	private Byte doc_type=0;//为了兼容app增加字段
